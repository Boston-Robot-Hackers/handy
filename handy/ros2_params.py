...
def main():
    if len(sys.argv) < 2:
        print(
            "Usage: python3 find_ros2_params.py <search_string> [timeout_seconds] [max_threads]"
        )
        print("\nExample:")
        print("  python3 find_ros2_params.py 'frame_id'")
        print("  python3 find_ros2_params.py 'topic' 3.0 16")
        sys.exit(1)
